...
//        System.out.println("Input             (hex): " + convertBytesToHex(input.getBytes()));
        ...
        System.out.println("\n---Encryption---");
        byte[] encryptedValue = cipher.encrypt(input.getBytes(), key);   // encrypt

//        System.out.println("Key               (hex): " + convertBytesToHex(key.getEncoded()));
//        System.out.println("Encrypted         (hex): " + convertBytesToHex(encryptedValue));

        System.out.println("\n---Print Mac and Nonce---");

//        ByteBuffer bb = ByteBuffer.wrap(encryptedValue);

        // This encryptedValue contains chacha20 ciphertext + poly1305 MAC + nonce
...
//        System.out.println("Nonce             (hex): " + convertBytesToHex(nonce));
        ...
        System.out.println("\n---Decryption---");
//        System.out.println("Input             (hex): " + convertBytesToHex(encryptedValue));

        byte[] pText = cipher.decrypt(encryptedValue, key);              // decrypt
