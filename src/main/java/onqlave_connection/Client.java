...
public interface Client {
    byte[] post(String resource, OnqlaveRequest body, Map<String, String> headers) throws IOException, InterruptedException;
}
...
public class ClientImpl implements Client {
    ...
    @Override
    public byte[] post(String resource, OnqlaveRequest body, Map<String, String> headers) throws IOException, InterruptedException {
        ...
        if (statusCode == 429) {
            ...
            BaseErrorResponse baseError = new Gson().fromJson(response.body().toString(), responses.BaseErrorResponse.class);
            if (baseError != null) {
